...
export default function DesignYourTrip() {
  ...
  const categories: TripCategory[] = [
    { id: "treks-in-nepal", categoryHandle: "treks-in-nepal", categoryName: "Treks in Nepal", categoryImage: null, createdAt: "" },
    { id: "tours-in-nepal", categoryHandle: "tours-in-nepal", categoryName: "Tours in Nepal", categoryImage: null, createdAt: "" },
    { id: "classic-trek", categoryHandle: "classic-trek", categoryName: "Classic Trek", categoryImage: null, createdAt: "" },
    { id: "high-altitude", categoryHandle: "high-altitude", categoryName: "High Altitude Expedition", categoryImage: null, createdAt: "" },
    { id: "cultural-tour", categoryHandle: "cultural-tour", categoryName: "Cultural and Heritage Tour", categoryImage: null, createdAt: "" },
    { id: "wildlife-safari", categoryHandle: "wildlife-safari", categoryName: "Wildlife and Nature Safari", categoryImage: null, createdAt: "" },
    { id: "luxury-trek", categoryHandle: "luxury-trek", categoryName: "Luxury Trek", categoryImage: null, createdAt: "" },
    { id: "adventure-sports", categoryHandle: "adventure-sports", categoryName: "Adventure and Extreme Sports", categoryImage: null, createdAt: "" },
    { id: "pilgrimage-tour", categoryHandle: "pilgrimage-tour", categoryName: "Pilgrimage Tour", categoryImage: null, createdAt: "" },
    { id: "photography-tour", categoryHandle: "photography-tour", categoryName: "Photography Tour", categoryImage: null, createdAt: "" },
    { id: "family-trek", categoryHandle: "family-trek", categoryName: "Family Friendly Trek", categoryImage: null, createdAt: "" },
    { id: "off-beaten-path", categoryHandle: "off-beaten-path", categoryName: "Off-the-beaten Path", categoryImage: null, createdAt: "" },
    { id: "honeymoon-package", categoryHandle: "honeymoon-package", categoryName: "Honeymoon Package", categoryImage: null, createdAt: "" },
    { id: "yoga-meditation", categoryHandle: "yoga-meditation", categoryName: "Yoga and Meditation Retreat", categoryImage: null, createdAt: "" },
  ];
  ...
  return (
    <main className="bg-canvas min-h-screen">
      ...
      <section className="max-w-6xl mx-auto px-6 py-16 md:py-24 grid grid-cols-1 lg:grid-cols-3 gap-12 items-start">
            ...
            <form onSubmit={form.handleSubmit(onSubmit)}>
              ...
              {step === 4 && (
                <div className="space-y-5">
                  ...
                  <div className="rounded-xl border border-hairline bg-canvas-soft p-4 space-y-2 text-sm">
