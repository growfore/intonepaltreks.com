    ...
    <Section className="bg-canvas">
      <div className="grid grid-cols-1 md:grid-cols-12 gap-10 md:gap-16 items-center">
        <div className="md:col-span-7">
          ...
          align="left"
            title={
              <h2 className="text-4xl md:text-6xl text-ink text-balance mb-8 font-bold">
                Explore the Himalaya <br className="hidden md:block" /> with{" "}
                <span className="font-black text-primary">Into Nepal.</span>
              </h2>
          }
          eyebrow="Our Story"
          />
          ...
          <div className="flex flex-col gap-6 text-body text-base md:text-lg leading-relaxed">
            ...
            <p className="font-script text-2xl text-ink mt-2 underline underline-offset-4">Arjun</p>
          </div>
